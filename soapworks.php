	...
	<body id="home">
		...
		<div id="content">
			<h1>Patterson Soapworks</h1>
				...
				<p>This is a customer facing website for a fictional, artisanal soap company. The goal is to highlight certain products and easily allow customers to browse the options, or fill in a form for custom orders. The pages are designed to be responsive for viewing on a variety of screens. The input on any form (including the &lsquo;add to cart&rsquo; form) is simply echoed back by a script on the Harvard Morpheus server to test functionality. This project started as part of classwork for Fundamentals of Website Design at Harvard Extension, and has been expanded since the course ended.</p>
				<p>Overall I was happy with the way this site turned out. &nbsp;I was, perhaps, a little over eager with background images and textures but I gained experience on fittine and editing backgrounds.&nbsp;</p>
				<h2>Features</h2>
				<ul>
