	...
	<body id="home">
		...
		<div id="content">
			<h1>Patterson Soapworks</h1>
				...
				<p>Overall I was happy with the way this site turned out. &nbsp;I was, perhaps, a little over eager with background images and textures but I gained experience on sizing and editing backgrounds.&nbsp; Using the PHP includes for product previews made me look forward to learning about content management and methods for dynamically updating a site like this.</p>
				<h2>Features</h2>
				<ul>
